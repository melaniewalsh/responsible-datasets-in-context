...
# 2d. Change the y-axis tick labes so that they abbreviate millions to M and thousands to K
...
ggplot(my_parks_df) +
  ...
  scale_y_continuous(labels = scales::label_number_si(), limits = c(0, 2000000)) +
