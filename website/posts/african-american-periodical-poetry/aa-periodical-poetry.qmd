...
viewof summary_data = SummaryTable(search, {label: "AA Poetry Data"})
//summary_data
```

{{< downloadthis ../../../datasets/aa-periodical-poetry/AAPADA-Periodical-Poetry_1900-1928.csv dname = AAPADA-Periodical-Poetry_1900-1928 label = "Download Data" id=downloadbutton >}}
...
filtered = aa_poetry_data.filter(function(penguin) {
...
{{< downloadthis ../../../datasets/aa-periodical-poetry/AAPADA-Periodical-Poetry_1900-1928.csv dname = AAPADA-Periodical-Poetry_1900-1928 label = "Download Data" type = downloadbutton >}}
