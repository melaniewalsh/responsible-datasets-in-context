...
[This essay discusses gender-based violence and sexual violence. The content may be distressing or triggering for some readers.]{style="text-align: right; font-style: italic; color: red !important;"}
...
generateTabulatorTableFromCSV(
  "#table-container-gv",
  "https://raw.githubusercontent.com/melaniewalsh/responsible-datasets-in-context/main/datasets/gender-violence/English_Bilingual_Database_of_El%20Silencio_de_la_Voz.csv",
  {
    displayedColumns: [
      "Case Number",
      "Age",
      ...
      "Facts About the Victim's Life",
      "Cause of death",
      "Characteristics of Death: position, state",
      "Clothing Details",
      "Potential Attackers",
      "Case ",
      "Incongruencies",
    ...
    columnPopups: [
      ...
      "Age of the victim.",
      "Name of the victim.",
      "Date the victim was found.",
      "Details about the victim's disappearance.",
      "Location where the victim was found.",
      "Physical characteristics of the victim.",
      "Facts about the victim's life.",
      "Cause of death.",
      "Characteristics of death including position and state.",
      "Details about the victim's clothing.",
      "Information about potential attackers.",
      "Case details.",
      "Incongruencies in the case.",
      "Related articles.",
      "Related photos.",
      "Additional notes."
    ],
    ...
    sortColumns: ["Case Number"],
    sortOrders: ["asc"],

    buttonContainerId: "#button-container-gv",
    rawButtonId: "#download-raw-gv",
    urlCopyButtonId: "#copy-url-gv",
  }
);
```

::: {#table-container-gv style="height: 500px"}
:::

Download Full Data

<div>
<button id="download-raw-gv"><i class="fas fa-download"></i> Download Full Data</button>
<button id="copy-url-gv"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (including filtered options)

<div id="button-container-gv">
...
![Front page of the book *El silencio que la voz de todas*](images/el-silencio-que-la-voz-de-todas-image14.png "Front page of the book _El silencio que la voz de todas_")
...
-   **Dataset #1: [*Tracing Feminicides in El Paso, Texas Using the Hispanic-American Newspaper Newsbank-Readex Collection*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/ERRyEGE0CLtCpx2UwXke8hgBA-WigVSJKZz6E7iSB_EvkA?e=5dUC0k)**
    -   **Team:** [Jessica Corona (Leader), Johanna León, Aislinn Reichle, & Sara Mosher]{style="text-decoration:underline;"}
...
-   **Dataset #2: [*Digital and Translated Version of "El Silencio De La Voz Que a Todos Nos Quiebra Feminicidio" Printed Spreadsheet*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/Ee3DNzkSz9pCtA4PLwtsr4kBvnAHBWdAwTis0iiNpXDkHg?e=NRwgPc)**
    -   **Team: [Jasbeth Medrano (Leader), Judith Ordonez, Carolina Vlaun, Alex Sanchez, & Samuel Hille]{style="text-decoration:underline;"}**
...
-   **Dataset #3: [*Geotestimonios Literary Dataset (Woman Hollering Creek by Sandra Cisneros and Stories of Survival by Alicia Gaspar de Alba).*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/EbmXffhLIvNClcOd_Mzl_PcBE8k0G6dwgQlvheM_FX7xFQ?e=lpoirv)**
    -   Team: [Genesis Esquilin (Leader), Layla Smith,]{style="text-decoration:underline;"}Kiri Avelar, & [Paris Cantu]{style="text-decoration:underline;"}
...
-   **Dataset #4: [*Films of Feminicide and/or Gender Violence Around the World*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/Ed5N9T-imoNNgKv2VBVDfNQBbLQwjHmvYXOR0s9XNZdZeQ?e=5CM5Jz)**
    -   **Team: [Nicolas Rodriguez (Leader), Madee Puente-Bonilla]{style="text-decoration:underline;"}**, [Julian Dehoyos, Jada Thomas, & Lily Morrill]{style="text-decoration:underline;"}
...
-   **Dataset #5: [*Books and Articles from Mexico and the U.S. Related to Feminicide and Gender Violence*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/EeZ2sbQ96GJNhqHVMzF9tZUByPzNOhcozSshn6dqJjLiNA?e=SoagHc)**
    -   **Team:** [Jared Pond (Leader), Emily Malloy (Leader), Erin Garza, Joshua Scott, & Ambonnay Rodriguez]{style="text-decoration:underline;"}
...
-   **Dataset #6: [*Murals and Public Monuments Related to Feminicide and Gender Violence*](https://utsacloud-my.sharepoint.com/:x:/g/personal/sylvia_fernandez_utsa_edu/EX7_WITUvZVPhcbk0c-dsXUBfdtoDdsMeU610vx_W7dnUw?e=MXlHGt)**
    -   **Team:** [Nilou Esmaeili (Leader), Jairo Samuda, Kai Pheonix, Anastasia Blanco, & Branden Jackson]{style="text-decoration:underline;"}
...
generateTabulatorTableFromCSV(
  ...
  "https://raw.githubusercontent.com/melaniewalsh/responsible-datasets-in-context/main/datasets/gender-violence/English_Bilingual_Database_of_El%20Silencio_de_la_Voz.csv",
  {
    ...
    buttonContainerId: "#button-container-gv-all",
    rawButtonId: "#download-raw-gv-all",
    urlCopyButtonId: "#copy-url-gv-all",
  }
);
```

::: {#table-container-gv-all style="height: 500px"}
:::

Download Full Data

<div>
<button id="download-raw-gv-all"><i class="fas fa-download"></i> Download Full Data</button>
<button id="copy-url-gv-all"><i class="fas fa-copy"></i> Copy Full Data URL</button>
</div>

Download Table Data (including filtered options)

<div id="button-container-gv-all">
<button id="download-csv"><i class="fas fa-download"></i> Download CSV</button>
<button id="download-json"><i class="fas fa-download"></i> Download JSON</button>
<button id="download-xlsx"><i class="fas fa-download"></i> Download Excel</button>
</div>
