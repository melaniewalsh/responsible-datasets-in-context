---
title: "COPY Gender Violence at the Border (1993-1998)"
...
<!-- Importing ojs variables from https://observablehq.com/d/43c63c0752531267 -->
```{ojs}
//| echo: false
import {viewof dataSummaryView, viewof dataUrl, viewof dataSet, tableContainer, table, tableStyles} from "43c63c0752531267"
```
...
<!-- Maybe fix this so that it downloads whichever dataset is being shown -->
