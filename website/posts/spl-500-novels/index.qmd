...
fig = px.line(pride_prejudice_timeseries, x='year-month', y='checkouts', title='Pride and Prejudice Checkouts Over Time', labels={'year-month': 'Year-Month', 'checkouts': 'Number of Checkouts'})
fig.show()
```
