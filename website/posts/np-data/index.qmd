...
```{ojs}
//|echo: false
import {viewof dataSummaryView, viewof selectedColumns, viewof dataUrl, viewof dataSet, tableContainer, table, viewof twobuttons, tableStyles} from "ac13d95a907715bf"
```
...
The National Park datasets included here are drawn from data published by the National Park Service, and most (but not all) of the contextual information also draws from material published by the National Park Service. We decided to publish this data along with our own synthesized documentation and narrative because the original data is made available in an [NPS data portal](https://irma.nps.gov/Stats/) that is relatively hard to find and use, and the documentation is distributed across many different web pages, PDFs, and other documents. 

The datasets were curated and published by Melanie Walsh, and the data essay was written by Os Keyes and Melanie Walsh.

## History

A national park is a natural area that a country deems so important that they decide to officially protect, preserve, and make that area available to the public. There are national parks around the world (as you can learn in this Netflix documentary narrated by Barack Obama). In the United States, the very first National Park — Yellowstone National Park, in Wyoming — was signed into law in 1872 by President Ulysses S. Grant. A handful of other parks — Sequoia, Yosemite, Mt. Rainier, Crater Lake —  joined the system in the next several decades. While the National Parks were originally created to protect precious, beautiful lands and make them accessible to everyday peopple — a noble goal - it's important to remember that these lands were often taken, sometimes forcibly, from Native American people who already owned, lived, and worked on them [@beauchamp_beyond_2020]. Today, there are still calls for the NPS to [return the lands of the National Parks to Indigenous people.](https://www.theatlantic.com/magazine/archive/2021/05/return-the-national-parks-to-the-tribes/618395/) 

Scholars have similarly shown that early conservation movements, which spurred the development of the National Parks, were troublingly intertwined with racism and eugenics movements [@beauchamp_beyond_2020]. These prejudiced origins---combined with continuing forms of environmental racism---have contributed to the marginalization of people of color and other minorities in the parks. Research has shown that white people visit the parks much more than other demographic groups [@weber_why_2013; @alba_covid-19s_2022; @floyd_coming_2002]. So, while the National Parks are technically open to anyone, they are not accessible to everyone in the same way, and these exclusions shape the parks' visitation data even before it's counted.

So when and why did they start counting visits to the U.S. National Parks? Well, according to the NPS, the counting of park visitors started [as early as 1904](https://www.nps.gov/subjects/socialscience/visitor-use-statistics.htm) (more than 10 years before the National Park Service itself was officially created). But at this time, their data collection methods were mostly [informal, inconsistent, and low-tech](https://www.nps.gov/subjects/socialscience/visitor-use-statistics.htm). 
...
The NPS started getting serious about data collection when a new law was passed. In 1965, the U.S. Congress passed [The Land and Water Conservation Fund Act of 1965](https://www.everycrsreport.com/reports/RL33531.html). This act created a new source of government money specifically dedicated to protecting natural resources (i.e. to buying up more land and water so that condo developers couldn't do it first) and to expanding outdoor recreation infrastructure in the U.S. Because the act stipulated that the amount of money allocated to each area should be ["proportional to visitor use,"](https://www.nps.gov/subjects/socialscience/statistics-history.htm) the NPS buckled down on counting visitor use. Over the next twenty years, they accordingly ["developed and institutionalized a formal system for collecting, compiling and reporting visitor use data."](https://www.nps.gov/subjects/socialscience/statistics-history.htm)

Today's National Park data collection system is more formal and sophisticated than the one that the NPS used in 1904, but there are still many inconsistencies, flaws, and limitations. The data does not represent the true number of people who have visited the parks. Think about it. Would it be possible to record \*every\* \*single\* \*visit\* to \*every\* \*single\* National Park... \*ever\*? Can you count every single one of the hundreds of millions of people who walked, hiked, backpacked, drove, canoed, biked, or skiied into each of the 60 different parks over the last four decades? These parks are located in dozens of different geographic areas (mountains, volcanoes, deserts, canyons, wetlands, forests, islands, and more); they have experienced countless changing weather conditions; and they each have different levels of staffing and funding that have changed over time, too. It's just not possible. But we believe the data is useful to study precisely for this reason: because it helps demonstrate that ***data never reflects reality precisely***.
