...
While today's National Park data collection system is more formal and sophisticated than the one that the NPS used in 1904, there are still many inconsistencies, flaws, and limitations. These shortcomings are largely unavoidable. Think about it. Would it be possible to record *every.* *single.* *visit.* to *every.* *single.* National Park *ever*? We're talking about dozens of different parks and geographic regions; many decades of time; countless changing weather conditions; a great deal of economic fluctuation; and hundreds of millions of people. It's just not possible. But we believe this data is useful to study precisely for this reason: because it helps demonstrate that ***data never reflects reality precisely***.
