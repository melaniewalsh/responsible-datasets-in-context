...
<br>
<!-- Importing from https://observablehq.com/d/d85c628332300765 -->

```{ojs}
import {viewof dataSummaryView, viewof selectedColumns, viewof dataUrl, viewof dataSet, tableContainer, table, tableStyles} from "d85c628332300765"
```
