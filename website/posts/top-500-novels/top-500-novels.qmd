    ...
    include-in-header:
      - text: |
          ...
          function htmlTableOfContents(documentRef) {
              ...
              var headings = [].slice.call(activeTabPane.querySelectorAll('h1, h2'));
...
<!-- Importing from https://observablehq.com/d/ac5fc74c20ef36a6 (forked, collaborative notebook) -->

```{ojs}
//|echo: false
import {viewof dataSummaryView, viewof selectedColumns, viewof dataUrl, viewof dataSet, tableContainer, table, tableStyles} from "ac5fc74c20ef36a6"
```
...
![Screenshot of "The Library Top 100"](images/top_500_kit.png "image_tooltip")
...
![VIAF example of Toni Morrison's novel *Beloved*](images/viaf_example.png "image_tooltip")
