      ...
      - text: |
          ...
          document.addEventListener('click', function(event) {
              if (event.target.matches('.nav.nav-tabs .nav-item .nav-link')) {
                  setTimeout(htmlTableOfContents, 1);  // Delay to wait for the tab to become active
              }
          });
          </script>    
  #ipynb: default
