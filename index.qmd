...
By providing these contextual materials, we hope to enable the responsible use of these particular datasets for teaching, research, and general exploration. More broadly, we seek to promote the responsible use of all data —whether in the classroom, industry, or the wider world—by underscoring the essential significance of context in data-related work.
