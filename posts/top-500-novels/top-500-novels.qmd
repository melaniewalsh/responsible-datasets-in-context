...
//| echo: false
//| output: false
library_data = d3.csv("https://github.com/melaniewalsh/responsible-datasets-in-context/raw/main/datasets/top-500-novels/library_top_500%20-%20fields_for_full_dataset.csv", d3.autoType)
...
Inputs.table(search, {
  ...
  format: {
    ...
    gr_avg_rating: x => html`<div style='background:${color(x)}'>${d3.format('.2s')(x)}</div>`
  }
})
```
